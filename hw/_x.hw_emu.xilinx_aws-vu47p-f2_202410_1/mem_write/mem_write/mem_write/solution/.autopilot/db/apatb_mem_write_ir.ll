; ModuleID = '/home/ubuntu/samml_fpga/hw/_x.hw_emu.xilinx_aws-vu47p-f2_202410_1/mem_write/mem_write/mem_write/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_mem_write_ir(i32* noalias nocapture nonnull %mem, i32 %size, %"class.hls::stream<ap_int<17>, 0>"* noalias nocapture nonnull dereferenceable(4) %stream) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_mem_write_hw(i32* %mem_copy, i32 %size, i17* %stream_copy)
...
declare void @apatb_mem_write_hw(i32*, i32, i17*)
...
define void @mem_write_hw_stub_wrapper(i32*, i32, i17*) #7 {
entry:
  %3 = alloca %"class.hls::stream<ap_int<17>, 0>"
  call void @copy_out(i32* null, i32* %0, %"class.hls::stream<ap_int<17>, 0>"* %3, i17* %2)
  call void @mem_write_hw_stub(i32* %0, i32 %1, %"class.hls::stream<ap_int<17>, 0>"* %3)
  call void @copy_in(i32* null, i32* %0, %"class.hls::stream<ap_int<17>, 0>"* %3, i17* %2)
  ret void
}

declare void @mem_write_hw_stub(i32* noalias nocapture nonnull, i32, %"class.hls::stream<ap_int<17>, 0>"* noalias nocapture nonnull)
