...
set C_modelArgList {
	...
	{ stream int 24 regular {axi_s 0 volatile  { stream Data } }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "mem","offset": { "type": "dynamic","port_name": "mem","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "stream", "interface" : "axis", "bitwidth" : 24, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ stream_TVALID sc_in sc_logic 1 invld 3 } 
	...
	{ stream_TDATA sc_in sc_lv 24 signal 3 } 
	{ stream_TREADY sc_out sc_logic 1 inacc 3 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"mem_write","role":"start","value":"0","valid_bit":"0"},{"name":"mem_write","role":"continue","value":"0","valid_bit":"4"},{"name":"mem_write","role":"auto_start","value":"0","valid_bit":"7"},{"name":"mem","role":"data","value":"16"},{"name":"size","role":"data","value":"28"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"mem_write","role":"start","value":"0","valid_bit":"0"},{"name":"mem_write","role":"done","value":"0","valid_bit":"1"},{"name":"mem_write","role":"idle","value":"0","valid_bit":"2"},{"name":"mem_write","role":"ready","value":"0","valid_bit":"3"},{"name":"mem_write","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "stream_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "stream", "role": "TVALID" }} , 
 	...
 	{ "name": "stream_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "stream", "role": "TDATA" }} , 
 	{ "name": "stream_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "stream", "role": "TREADY" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "stream", "Type" : "Axis", "Direction" : "I",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	mem_write {
		...
		stream {Type I LastRead 1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	stream { axis {  { stream_TVALID in_vld 0 1 }  { stream_TDATA in_data 0 24 }  { stream_TREADY in_acc 1 1 } } }
}
