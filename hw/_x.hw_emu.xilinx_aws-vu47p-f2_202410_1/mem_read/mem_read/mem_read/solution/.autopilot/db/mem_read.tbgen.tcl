...
set C_modelArgList {
	...
	{ stream int 24 regular {axi_s 1 volatile  { stream Data } }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "mem","offset": { "type": "dynamic","port_name": "mem","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "stream", "interface" : "axis", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ stream_TREADY sc_in sc_logic 1 outacc 3 } 
	...
	{ stream_TDATA sc_out sc_lv 24 signal 3 } 
	{ stream_TVALID sc_out sc_logic 1 outvld 3 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"mem_read","role":"start","value":"0","valid_bit":"0"},{"name":"mem_read","role":"continue","value":"0","valid_bit":"4"},{"name":"mem_read","role":"auto_start","value":"0","valid_bit":"7"},{"name":"mem","role":"data","value":"16"},{"name":"size","role":"data","value":"28"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"mem_read","role":"start","value":"0","valid_bit":"0"},{"name":"mem_read","role":"done","value":"0","valid_bit":"1"},{"name":"mem_read","role":"idle","value":"0","valid_bit":"2"},{"name":"mem_read","role":"ready","value":"0","valid_bit":"3"},{"name":"mem_read","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "control", "role": "interrupt" } }, 
 	...
 	{ "name": "stream_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "stream", "role": "TREADY" }} , 
 	...
 	{ "name": "stream_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "stream", "role": "TDATA" }} , 
 	{ "name": "stream_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "stream", "role": "TVALID" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_stream_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	mem_read {
		...
		stream {Type O LastRead -1 FirstWrite 73}}}
...
set Spec2ImplPortList { 
	...
	stream { axis {  { stream_TREADY out_acc 0 1 }  { stream_TDATA out_data 1 24 }  { stream_TVALID out_vld 1 1 } } }
}
